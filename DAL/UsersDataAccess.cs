                ...
                using (SqlCommand _command = new SqlCommand("SP_User_Update", _connection))
                {
                    ...
                    using (SqlDataReader _reader = _command.ExecuteReader())
                    {
                        while (_reader.Read())
                        {
                            ...
                            userToUpdate.Password = _reader.GetString(6);
                            userToUpdate.Username = _reader.GetString(7);
                            userToUpdate.UserID = _reader.GetInt32(8);
                            userToUpdate.RoleID = _reader.GetInt32(9);
                        }
                        _connection.Close();
                    }
